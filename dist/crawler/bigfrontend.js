...
var task = function (browser, url) { return __awaiter(void 0, void 0, void 0, function () {
    var page, question, title;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 3:
                ...
                return [4, page.$('[class^=ProblemDetailJS]')];
            case 4:
                question = _a.sent();
                return [4, page.evaluate(function () {
                        var actions = document.querySelector('[class^=Actions]');
                        actions.remove();
                        var title = document.querySelector('[class^=UI__BelowTitle]');
                        title.remove();
            ...
            case 6:
                title = _a.sent();
                return [4, (question === null || question === void 0 ? void 0 : question.screenshot({ path: "./dist/crawler/screenshots/".concat(title, ".png") }))];
            case 7:
                _a.sent();
                return [3, 10];
            case 8: return [4, page.close()];
            case 9:
                _a.sent();
                return [7];
            case 10: return [2];
...
var init = function (route) { return __awaiter(void 0, void 0, void 0, function () {
    var URL, browser, page, urls, problemUrls;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                URL = "https://bigfrontend.dev";
                return [4, createInstance(false)];
            case 1:
                browser = _a.sent();
                _a.label = 2;
            case 2:
            ...
            case 3:
                page = _a.sent();
                return [4, (0, page_1.goToURL)(page, "".concat(URL, "/").concat(route))];
            case 4:
                _a.sent();
                return [4, page.evaluate(function (fn) {
                        return Function(fn)();
                    }, search_1.searchDOMBreadthFirst.toString() + ";return ".concat(search_1.searchDOMBreadthFirst.name, "()"))];
            case 5:
                urls = _a.sent();
                problemUrls = urls[0];
                return [4, page.close()];
            case 6:
                ...
                return [4, (0, throttler_1.throttleFunctionExecution)(function (url) { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4, task(browser, url)];
